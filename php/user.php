<?php
    ...
    $result = pg_query($con,"SELECT * FROM users WHERE username='". $_SESSION["username"]."';");
    $result1 = pg_query($con,"SELECT * FROM users_history WHERE username='". $_SESSION["username"]."';");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="row">
    ...
    <!----------------------------Change-Profile---------------------------------------->
        <div class="col-12 col-s-12">
            ...
            <?php $row1 = pg_fetch_array($result)?>

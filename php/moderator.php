<?php
    ...
    $multiple_choices = pg_query($con,"SELECT * FROM multiple_choices");
    $one_choice = pg_query($con,"SELECT * FROM one_choice");
    $text_completion = pg_query($con,"SELECT * FROM text_completion");
    $true_false = pg_query($con,"SELECT * FROM true_false");
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="col-12 col-s-12 row" >
            ...
            <b class="Type_of_array">Multiple choices</b>
                <table id="table1" >
                    ...
                    <?php
                        $i=0;
                        while($row = pg_fetch_array($multiple_choices)) {
                    ?>
                    <tr>
            ...
            <article>
                ...
                <thead>
                    ...
                    <?php
                        $i=0;
                        while($row = pg_fetch_array($one_choice)) {
                    ?>
                    <tr>
                        <td data-label="Id" class="hidden"><?php echo $row["id"]; ?></td>
                        <td data-label="Question"><?php echo $row["question"]; ?></td>
            ...
            <article>
                ...
                <table id="table3" >
                    ...
                    <?php
                        $i=0;
                        while($row = pg_fetch_array($text_completion)) {
                    ?>
                    <tr>
                        <td data-label="id" class="hidden" ><?php echo $row["id"]; ?></td>
                        <td data-label="Question"><?php echo $row["question"]; ?></td>
            ...
            <b class="Type_of_array">True false</b>
                <table id="table4" >
                    ...
                    <?php
                        $i=0;
                        while($row = pg_fetch_array($true_false)) {
                    ?>
                    <tr>
                        <td data-label="id"class="hidden"><?php echo $row["id"]; ?></td>
                        <td data-label="Question"><?php echo $row["question"]; ?></td>

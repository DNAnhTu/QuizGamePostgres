		...
		<div class="row">
			<div class="col-2 col-s-3" >
				...
				<div class="quizButtons">
					...
					<button class="btn btn-white-reload btn-animation-1-reload" onClick="document.location.reload(true)" name="Reload" id="reload">Reload</button></br>
					<?php
			...
			<div class="col-10 col-s-9">
				...
				<div class="show" id="Easy">
					<!---------------------------Quiz 1 ------------------------------------------->
							...
							<!--------------------------------------Quiz 2----------------------------------------->
							<?php $row2 = pg_fetch_array($result2) ?>
				...
				<div class="hidden" id="Medium">
					<!---------------------------Quiz 1 ------------------------------------------->
							...
							<!--------------------------------------Quiz 2----------------------------------------->
							<?php $row6 = pg_fetch_array($result6) ?>
								<div id="quiz2" class="quiz">
				...
				<div class="hidden" id="Hard">
					<!---------------------------Quiz 1 ------------------------------------------->
							...
							<!--------------------------------------Quiz 2----------------------------------------->
							<?php $row10 = pg_fetch_array($result10) ?>
								<div id="quiz2" class="quiz">
